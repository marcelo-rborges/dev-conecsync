              ...
              PRODUTOS.push(
                {
                  ...
                  idDepartamento: FIELD_CONTENTS['ID_DEPARTAMENTO'] >= 0 && ROW.at(FIELD_CONTENTS['ID_DEPARTAMENTO']) || '',
                  nomeDepartamento: FIELD_CONTENTS['NOME_DEPARTAMENTO'] >= 0 && ROW.at(FIELD_CONTENTS['NOME_DEPARTAMENTO']) || '',
                  ativoDepartamento: FIELD_CONTENTS['ATIVO_DEPARTAMENTO'] >= 0 && ROW.at(FIELD_CONTENTS['ATIVO_DEPARTAMENTO']) || '',
                  idSubdepartamento: FIELD_CONTENTS['ID_SUBDEPARTAMENTO'] >= 0 && ROW.at(FIELD_CONTENTS['ID_SUBDEPARTAMENTO']) || '',
                  nomeSubdepartamento: FIELD_CONTENTS['NOME_SUBDEPARTAMENTO'] >= 0 && ROW.at(FIELD_CONTENTS['NOME_SUBDEPARTAMENTO']) || '',
                  ativoSubdepartamento: FIELD_CONTENTS['ATIVO_SUBDEPARTAMENTO'] >= 0 && ROW.at(FIELD_CONTENTS['ATIVO_SUBDEPARTAMENTO']) || '',
