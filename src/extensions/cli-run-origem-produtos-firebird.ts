                ...
                const RESULTADO = (result || []).map(
                  (row: any) => {
                    return {
                      ...
                      idDepartamento: fixBuffStr(get(row, 'ID_DEPARTAMENTO')) || '',
                      nomeDepartamento: fixBuffStr(get(row, 'NOME_DEPARTAMENTO')) || '',
                      ativoDepartamento: fixBuffStr(get(row, 'ATIVO_DEPARTAMENTO')) || '',
                      idSubdepartamento: fixBuffStr(get(row, 'ID_SUBDEPARTAMENTO')) || '',
                      nomeSubdepartamento: fixBuffStr(get(row, 'NOME_SUBDEPARTAMENTO')) || '',
                      ativoSubdepartamento: fixBuffStr(get(row, 'ATIVO_SUBDEPARTAMENTO')) || '',
